...
uint8_t volatile iPassed = 0; // Program 1 and 3 have counted to at least 9
uint8_t volatile jExpected = 0; // The expected value for j in program 2. Must reach at least 'z'
